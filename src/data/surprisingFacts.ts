...
export const surprisingScenarios: SurprisingScenario[] = [
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Opisthokonta',
        label: 'Opisthokonta - Wikipedia',
      },
      {
        url: 'https://gizmodo.com/why-are-mushrooms-more-like-humans-than-they-are-like-p-5940434',
        label: 'Gizmodo - Why mushrooms are more like humans than plants',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Deuterostome - Wikipedia',
      },
      {
        url: 'https://www.abc.net.au/science/articles/2006/11/10/1785449.htm',
        label: 'ABC Science - Sea urchins are our cousins',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Odd-toed ungulate - Wikipedia',
      },
      {
        url: 'https://positivepeerpressure.blog/quirky-evolution-5-unlikely-animal-relatives-hiding-in-plain-sight-6e08cfd299a7',
        label: 'Quirky Evolution - Unlikely animal relatives',
      },
      {
        url: 'https://www.sci.news/paleontology/modern-horse-toes-12022.html',
        label: 'Sci.News - Modern horse toes',
      },
      {
        url: 'https://en.wikipedia.org/wiki/Evolution_of_the_horse',
        label: 'Evolution of the horse - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Afrotheria',
        label: 'Afrotheria - Wikipedia',
      },
      {
        url: 'https://en.wikipedia.org/wiki/Hyrax',
        label: 'Hyrax - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Flowering plant - Wikipedia',
      },
      {
        url: 'https://www.youtube.com/watch?v=ONVpFtiD-fo',
        label: 'Domain of Life - The Surprising Map of Plants',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Laurasiatheria',
        label: 'Laurasiatheria - Wikipedia',
      },
      {
        url: 'https://www.batcon.org/surprising-bat-relatives/',
        label: 'Bat Conservation International - Surprising bat relatives',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.livescience.com/55241-aardvark-facts.html',
        label: 'Live Science - Aardvark facts',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Caniformia - Wikipedia',
      },
      {
        url: 'https://www.youtube.com/watch?v=aAOsf004FqQ',
        label: 'YouTube - Seals are related to dogs and bears',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Eulipotyphla',
        label: 'Eulipotyphla - Wikipedia',
      },
      {
        url: 'https://www.youtube.com/shorts/jRPiiXKmZIA',
        label: 'YouTube - Shrews are closer to cats than mice',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Anacardiaceae',
        label: 'Anacardiaceae - Wikipedia',
      },
      {
        url: 'https://www.scientificamerican.com/article/what-do-cashews-mangoes-and-poison-ivy-have-in-common/',
        label: 'Scientific American - Cashews, mangoes, and poison ivy',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Alveolata',
        label: 'Alveolata - Wikipedia',
      },
      {
        url: 'https://www.youtube.com/watch?v=4ejoVBcLP4U',
        label: 'PBS Eons - How Our Deadliest Parasite Turned To The Dark Side',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://www.scientificamerican.com/article/slow-evolving-lobe-finned-coelacanth-genome-unlocked/',
        label: 'Coelacanth Genome Unlocked - Scientific American',
      },
      {
        url: 'https://ocean.si.edu/ocean-life/fish/coelacanth',
        label: 'Smithsonian Ocean - Coelacanth',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Archosaur',
        label: 'Archosaur - Wikipedia',
      },
      {
        url: 'https://www.earth.com/news/crocodiles-birds-archosaurs/',
        label: 'Earth.com - Crocodiles and birds are archosaurs',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Falconidae - Wikipedia',
      },
      {
        url: 'https://www.birdnote.org/explore/field-notes/2015/02/parrots-and-falcons-long-lost-cousins',
        label: 'BirdNote - Parrots and falcons: long-lost cousins',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Strigiformes',
        label: 'Strigiformes - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/animal/caprimulgiform/Evolution-and-paleontology',
        label: 'Britannica - Caprimulgiform evolution and paleontology',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Tetraodontiformes',
        label: 'Tetraodontiformes - Wikipedia',
      },
      {
        url: 'https://ocean.si.edu/ocean-life/fish/pufferfishes-and-their-relatives',
        label: 'Smithsonian Ocean - Pufferfishes and their relatives',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Mudskipper - Wikipedia',
      },
      {
        url: 'https://www.discovermagazine.com/meet-the-mudskipper-the-fish-that-walks-on-land-44915',
        label: 'Discover Magazine - Meet the mudskipper',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Mustelidae',
        label: 'Mustelidae - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/animal/wolverine',
        label: 'Britannica - Wolverine',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Rhynchocephalia',
        label: 'Rhynchocephalia - Wikipedia',
      },
      {
        url: 'https://theconversation.com/not-a-lizard-nor-a-dinosaur-tuatara-is-the-sole-survivor-of-a-once-widespread-reptile-group-75921',
        label:
          'The Conversation - Tuatara is the sole survivor of a once-widespread reptile group',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Cetartiodactyla',
        label: 'Cetartiodactyla - Wikipedia',
      },
      {
        url: 'https://evolution.berkeley.edu/what-are-evograms/the-evolution-of-whales/',
        label: 'UC Berkeley - The evolution of whales',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Evolution_of_cetaceans',
        label: 'Evolution of cetaceans - Wikipedia',
      },
      {
        url: 'https://us.whales.org/whales-dolphins/how-did-whales-evolve/',
        label: 'Whale & Dolphin Conservation - How did whales evolve?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Sirenia#Evolution',
        label: 'Sirenia evolution - Wikipedia',
      },
      {
        url: 'https://www.livescience.com/weird-relatives-of-elephants.html',
        label: 'Live Science - Weird relatives of elephants',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Marine_mammal#Evolution',
        label: 'Marine mammal evolution - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/animal/pinniped',
        label: 'Britannica - Pinnipeds',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://www.nationalgeographic.com/animals/article/horseshoe-crabs-related-to-spiders',
        label:
          'Horseshoe crabs are spider relatives, genes reveal - National Geographic',
      },
      {
        url: 'https://oceanservice.noaa.gov/facts/horseshoe-crab.html',
        label: 'NOAA - Are horseshoe crabs really crabs?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Acari',
        label: 'Acari - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      { url: 'https://en.wikipedia.org/wiki/Tick', label: 'Tick - Wikipedia' },
      {
        url: 'https://en.wikipedia.org/wiki/Chelicerata',
        label: 'Chelicerata - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Mollusca',
        label: 'Mollusca - Wikipedia',
      },
      {
        url: 'https://www.dgs.udel.edu/node/449',
        label:
          'Delaware Geological Survey - Clams, snails, and squid: Phylum Mollusca',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Osteichthyes',
        label: 'Osteichthyes - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Echinoderm - Wikipedia',
      },
      {
        url: 'https://ucmp.berkeley.edu/phyla/deuterostomia.html',
        label: 'UC Berkeley - Introduction to the Deuterostomia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Hippopotamus#Evolution',
        label: 'Hippopotamus evolution - Wikipedia',
      },
      {
        url: 'https://evolution.berkeley.edu/what-are-evograms/the-evolution-of-whales/',
        label: 'UC Berkeley - The evolution of whales',
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Elephant_shrew',
        label: 'Elephant shrew - Wikipedia',
      },
      {
        url: 'https://www.awf.org/wildlife-conservation/elephant-shrew',
        label: 'African Wildlife Foundation - Elephant shrew',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Tenrecidae',
        label: 'Tenrecidae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Lungfish - Wikipedia',
      },
      {
        url: 'https://www.nature.com/articles/s41586-021-03198-8',
        label: 'Nature - Giant lungfish genome elucidates the conquest of land',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.pnas.org/doi/10.1073/pnas.96.18.10261',
        label:
          'PNAS - Hippopotamuses are the closest extant relatives of whales',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.acsh.org/news/2018/12/12/are-raccoons-more-dogs-or-cats-13660',
        label: 'ACSH - Are raccoons more like dogs or cats?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Hyena#Evolution',
        label: 'Hyena evolution - Wikipedia',
      },
      {
        url: 'https://a-z-animals.com/animals/hyena/understanding-hyenas-are-they-canines-felines-or-unique-creatures/',
        label:
          'A-Z Animals - Are hyenas canines, felines, or unique creatures?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Feliformia',
        label: 'Feliformia - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Eupleridae',
        label: 'Eupleridae - Wikipedia',
      },
      {
        url: 'https://animals.sandiegozoo.org/animals/fossa',
        label: 'San Diego Zoo - Fossa',
      },
      {
        url: 'https://yoderlab.org/cms/wp-content/uploads/2014/05/2003YoderBurnsNature.pdf',
        label:
          'Yoder et al. 2003 - Single origin of Malagasy Carnivora (Nature)',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Pinniped#Evolution',
        label: 'Pinniped evolution - Wikipedia',
      },
      {
        url: 'https://ocean.si.edu/ocean-life/marine-mammals/seals-sea-lions-and-walruses',
        label: 'Smithsonian Ocean - Pinnipeds',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Euarchontoglires',
        label: 'Euarchontoglires - Wikipedia',
      },
      {
        url: 'https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0030002',
        label:
          'PLOS Computational Biology - Phylogenomic study of human, dog, and mouse',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Haplorhini',
        label: 'Haplorhini - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Hominidae - Wikipedia',
      },
      {
        url: 'https://humanorigins.si.edu/evidence/genetics',
        label: 'Smithsonian Human Origins - Genetics of great ape family tree',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Glires',
        label: 'Glires - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Muridae',
        label: 'Muridae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Lagomorpha',
        label: 'Lagomorpha - Wikipedia',
      },
    ],
  },
  // Surprising plant relationships
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Ericales',
        label: 'Ericales - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Malvaceae',
        label: 'Malvaceae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Caryophyllales',
        label: 'Caryophyllales - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/plant/Caryophyllales/Characteristic-morphological-features',
        label: 'Britannica - Caryophyllales',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Nelumbo',
        label: 'Nelumbo - Wikipedia',
      },
      {
        url: 'https://laidbackgardener.blog/2018/10/23/water-lily-pond-lily-or-lotus/',
        label: 'Laidback Gardener - Lotus is not a water lily',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Rosaceae',
        label: 'Rosaceae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Tunicate - Wikipedia',
      },
      {
        url: 'https://www.adfg.alaska.gov/index.cfm?adfg=wildlifenews.view_article&articles_id=455',
        label: 'Alaska Fish & Game - Your cousin the sea squirt',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Olfactores',
        label: 'Olfactores - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Gnathostomata',
        label: 'Gnathostomata - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Your_Inner_Fish',
        label: 'Your Inner Fish - Wikipedia',
      },
      {
        url: 'https://www.pbs.org/your-inner-fish/about/overview/',
        label: 'PBS - Your Inner Fish series overview',
      },
    ],
  },
  // Weird insect ones
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Hymenoptera',
        label: 'Hymenoptera - Wikipedia',
      },
      {
        url: 'https://www.si.edu/spotlight/buginfo/hymenoptera',
        label: 'Smithsonian - Wasps, ants, and bees (Hymenoptera)',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Holometabolism',
        label: 'Holometabolism - Wikipedia',
      },
      {
        url: 'https://www.scientificamerican.com/article/insect-metamorphosis-evolution/',
        label: 'Scientific American - How did insect metamorphosis evolve?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Endopterygota',
        label: 'Endopterygota - Wikipedia',
      },
    ],
  },
  // Jellyfish, sponges, corals, and deep animal phylogeny
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Porifera',
        label: 'Porifera - Wikipedia',
      },
      {
        url: 'https://www.science.org/doi/10.1126/science.abj2949',
        label:
          'Science - Profiling cellular diversity in sponges informs animal cell type and nervous system evolution',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://github.com/caseywdunn/sk25',
        label: 'Dunn et al. - Reanalysis of sponge-sister evidence',
      },
      {
      ...
      {
        url: 'https://www.mbari.org/news/genetic-research-offers-new-perspective-on-the-early-evolution-of-animals/',
        label: 'MBARI - New perspective on early animal evolution',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Jellyfish#Phylogeny',
        label: 'Jellyfish phylogeny - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Anthozoa',
        label: 'Anthozoa - Wikipedia',
      },
    ],
  },
  // Convergent evolution and misleading names
  {
    ...
    sources: [
      {
        url: 'https://www.scientificamerican.com/blog/tetrapod-zoology/surprises-from-placental-mammal-phylogeny-1-pangolins-are-close-kin-of-carnivorans/',
        label: 'Pangolins Are Close Kin of Carnivorans - Scientific American',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Barnacle',
        label: 'Barnacle - Wikipedia',
      },
      {
        url: 'https://oceanservice.noaa.gov/facts/barnacles.html',
        label: 'NOAA - What are barnacles?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Limpet',
        label: 'Limpet - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://www.scientificamerican.com/article/why-do-animals-keep-evolving-into-crabs/',
        label: 'Why Do Animals Keep Evolving into Crabs? - Scientific American',
      },
      {
        url: 'https://www.nature.com/articles/355539a0',
        label: 'Nature - Evolution of king crabs from hermit crab ancestors',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Lophotrochozoa',
        label: 'Lophotrochozoa - Wikipedia',
      },
      {
        url: 'https://courses.lumenlearning.com/suny-biology2xmaster/chapter/superphylum-lophotrochozoa/',
        label: 'Lumen Learning - Superphylum Lophotrochozoa',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Lamprey - Wikipedia',
      },
      {
        url: 'https://bio.libretexts.org/Bookshelves/Introductory_and_General_Biology/General_Biology_(Boundless)/29:_Vertebrates/29.02:_Fishes/29.2A:_Agnathans-_Jawless_Fishes',
        label: 'Biology LibreTexts - Jawless fishes',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Spiralia',
        label: 'Spiralia - Wikipedia',
      },
      {
        url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC2614230/',
        label: 'PMC - Assembling the lophotrochozoan (spiralian) tree of life',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Shipworm',
        label: 'Shipworm - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Priapulida',
        label: 'Priapulida - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://www.sciencedaily.com/releases/2011/03/110302184042.htm',
        label: 'Peanut worms are annelids - ScienceDaily',
      },
      {
        url: 'https://bmcgenomics.biomedcentral.com/articles/10.1186/1471-2164-10-136',
        label:
          'Mitochondrial genome evidence for Sipuncula-Annelida relationship - BMC Genomics',
      },
    ],
  },
    ...
    sources: [
      {
        ...
        label: 'Sugar glider - Wikipedia',
      },
      {
        url: 'https://evolution.berkeley.edu/examples-of-analogies/squirrels-and-sugar-gliders/',
        label: 'UC Berkeley - Squirrels and sugar gliders convergent evolution',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Giant_panda#Classification',
        label: 'Giant panda classification - Wikipedia',
      },
      {
        url: 'https://nationalzoo.si.edu/animals/news/red-panda-bear-and-more-red-panda-facts',
        label: 'Smithsonian Zoo - Red panda facts',
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Ceratomorpha',
        label: 'Ceratomorpha - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Cephalopod eye - Wikipedia',
      },
    ],
  },
  {
    organisms: [org('Chiton'), org('Sea angel'), org('Salp')],
    funFact:
      'The armored, rock-clinging chiton and the translucent, wing-flapping sea angel are both molluscs — relatives of snails and squid. The salp looks far more like the sea angel — transparent, gelatinous, drifting through open water — but salps are tunicates, chordates more closely related to humans than to any mollusc.',
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Polyplacophora',
        label: 'Polyplacophora - Wikipedia',
      },
      {
        url: 'https://en.wikipedia.org/wiki/Sea_angel',
        label: 'Sea angel - Wikipedia',
      },
    ],
  },
  {
    organisms: [org('Phylliroe'), org('Garden snail'), org('Phronima')],
    funFact:
      'Phylliroe is a nudibranch that looks like a tiny transparent fish — free-swimming in the open ocean, bioluminescent, with no shell at all. Phronima is also transparent and pelagic — a deep-sea amphipod that hollows out salps to live inside, and famously inspired the Alien movies. But Phylliroe is a gastropod mollusc, more closely related to the humble garden snail than to Phronima, which is a crustacean.',
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Phylliroe_bucephala',
        label: 'Phylliroe bucephala - Wikipedia',
      },
      {
        url: 'https://en.wikipedia.org/wiki/Phronima',
        label: 'Phronima - Wikipedia',
      },
    ],
  },
  {
  ...
  // Deep eukaryote / protist surprises
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Brown_algae',
        label: 'Brown algae - Wikipedia',
      },
      {
        url: 'https://bio.libretexts.org/Bookshelves/Introductory_and_General_Biology/General_Biology_(Boundless)/23:_Protists/23.03:_Groups_of_Protists/23.3C:_Chromalveolata-_Stramenopiles',
        label: 'Biology LibreTexts - Stramenopiles',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/SAR_supergroup',
        label: 'SAR supergroup - Wikipedia',
      },
    ],
  },
  // Fungi
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Ascomycota',
        label: 'Ascomycota - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Microsporidia',
        label: 'Microsporidia - Wikipedia',
      },
      {
        url: 'https://journals.asm.org/doi/10.1128/microbiolspec.funk-0018-2016',
        label:
          'ASM Microbiology Spectrum - Microsporidia within the fungal kingdom',
      },
    ],
  },
  // Plants
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Lemnoideae',
        label: 'Duckweed - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Eudicots',
        label: 'Eudicots - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      { url: 'https://en.wikipedia.org/wiki/Fern', label: 'Fern - Wikipedia' },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Welwitschia',
        label: 'Welwitschia - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/plant/tumboa',
        label: 'Britannica - Welwitschia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Ginkgo biloba - Wikipedia',
      },
      {
        url: 'https://www.nature.com/articles/s41467-019-12133-5',
        label:
          'Nature Communications - Evolutionary history of ginkgo, the living fossil',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Rafflesia',
        label: 'Rafflesia - Wikipedia',
      },
      {
        url: 'https://www.pnas.org/doi/10.1073/pnas.0305562101',
        label: 'PNAS - Photosynthetic relatives of Rafflesia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Cuscuta',
        label: 'Cuscuta - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Lauraceae',
        label: 'Lauraceae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Solanum',
        label: 'Solanum - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Monotropa_uniflora',
        label: 'Monotropa uniflora - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Tardigrade - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/animal/tardigrade',
        label: 'Britannica - Tardigrade',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Colugo - Wikipedia',
      },
      {
        url: 'https://www.sciencedaily.com/releases/2007/11/071101145003.htm',
        label: 'ScienceDaily - Flying lemurs are closest relatives of primates',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Okapi - Wikipedia',
      },
      {
        url: 'https://giraffeconservation.org/facts-about-giraffe/what-are-the-closest-relatives-of-giraffe/',
        label:
          'Giraffe Conservation Foundation - Okapi as closest giraffe relative',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Patagonian_mara',
        label: 'Patagonian mara - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        label: 'PMC - Molecules vs. morphology in pelecaniform birds',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Golden_mole',
        label: 'Golden mole - Wikipedia',
      },
      {
        url: 'https://www.afrotheria.net/golden-moles/',
        label: 'IUCN Afrotheria Specialist Group - Golden moles',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Naked mole-rat - Wikipedia',
      },
      {
        url: 'https://nationalzoo.si.edu/animals/naked-mole-rat',
        label: 'Smithsonian Zoo - Naked mole-rat',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Treeshrew',
        label: 'Treeshrew - Wikipedia',
      },
      {
        url: 'https://www.britannica.com/animal/tree-shrew',
        label: 'Britannica - Tree shrews',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Marsupial_mole',
        label: 'Marsupial mole - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Echidna - Wikipedia',
      },
      {
        url: 'https://www.scientificamerican.com/article/extreme-monotremes/',
        label: 'Scientific American - Extreme monotremes',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Aye-aye - Wikipedia',
      },
      {
        url: 'https://lemur.duke.edu/discover/meet-the-lemurs/aye-aye/',
        label: 'Duke Lemur Center - Aye-aye',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Pink_fairy_armadillo',
        label: 'Pink fairy armadillo - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://www.scientificamerican.com/blog/artful-amoeba/when-jellyfish-became-parasites-strange-things-happened/',
        label:
          'When Jellyfish Became Parasites, Strange Things Happened - Scientific American',
      },
      {
        url: 'https://www.pnas.org/doi/10.1073/pnas.1511468112',
        label:
          'PNAS - Genomic insights into the evolutionary origin of Myxozoa within Cnidaria',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Pancrustacea',
        label: 'Pancrustacea - Wikipedia',
      },
      {
        url: 'https://academic.oup.com/icb/article/55/5/765/604304',
        label:
          'Integrative and Comparative Biology - Linking insects with Crustacea',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Coconut crab - Wikipedia',
      },
      {
        url: 'https://www.nhm.ac.uk/discover/coconut-crabs-bird-eating-giants-on-tropical-islands.html',
        label: 'Natural History Museum London - Coconut crabs',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Porcelain_crab',
        label: 'Porcelain crab - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Slime mold - Wikipedia',
      },
      {
        url: 'https://www.nps.gov/articles/000/slime-molds.htm',
        label: 'National Park Service - Slime molds are not fungi',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Crinoid',
        label: 'Crinoid - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Brittle_star',
        label: 'Brittle star - Wikipedia',
      },
      {
        url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4046411/',
        label:
    ...
    sources: [
      {
        ...
        label: 'Mirandornithes - Wikipedia',
      },
      {
        url: 'https://www.10000birds.com/exploring-the-relationship-between-flamingos-and-grebes-the-wonderful-birds.htm',
        label: '10,000 Birds - Flamingos and grebes relationship',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Hoatzin - Wikipedia',
      },
      {
        url: 'https://www.pnas.org/doi/10.1073/pnas.92.25.11662',
        label: 'PNAS - Phylogenetic relationships of the hoatzin',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Caecilian - Wikipedia',
      },
      {
        url: 'https://www.nationalgeographic.com/animals/amphibians/facts/caecilians',
        label: 'National Geographic - Caecilians: limbless amphibians',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Protopterus',
        label: 'Protopterus - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      { url: 'https://en.wikipedia.org/wiki/Salp', label: 'Salp - Wikipedia' },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: "Portuguese man o' war - Wikipedia",
      },
      {
        url: 'https://oceanservice.noaa.gov/facts/portuguese-man-o-war.html',
        label: "NOAA - What is a Portuguese man o' war?",
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Vampire squid - Wikipedia',
      },
      {
        url: 'https://www.marinebio.org/species/vampire-squid/vampyroteuthis-infernalis/',
        label: 'MarineBio - Vampire squid',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Oomycete - Wikipedia',
      },
      {
        url: 'https://ucmp.berkeley.edu/chromista/oomycota.html',
        label: 'UC Berkeley - Oomycetes are not fungi',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Camelidae',
        label: 'Camelidae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Artiodactyla',
        label: 'Artiodactyla - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Muskox',
        label: 'Muskox - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Pronghorn - Wikipedia',
      },
      {
        url: 'https://www.nps.gov/articles/000/pronghorn.htm',
        label: 'National Park Service - Pronghorn',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Archelosauria - Wikipedia',
      },
      {
        url: 'https://bmcbiol.biomedcentral.com/articles/10.1186/1741-7007-10-65',
        label: 'BMC Biology - Turtles are sister group of birds and crocodiles',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Reptile#Phylogenetics',
        label: 'Reptile phylogenetics - Wikipedia',
      },
      {
        url: 'https://askabiologist.asu.edu/questions/birds-dinosaurs-reptiles',
        label: 'ASU Ask A Biologist - Are birds reptiles?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Neognathae',
        label: 'Neognathae - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Catarrhini',
        label: 'Catarrhini - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Theria',
        label: 'Theria - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Batrachia',
        label: 'Batrachia - Wikipedia',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Sarcopterygii',
        label: 'Sarcopterygii - Wikipedia',
      },
      {
        url: 'https://www.businessinsider.com/fish-do-not-exist-2016-8',
        label: 'Business Insider - There is no such thing as a fish',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Atlantogenata',
        label: 'Atlantogenata - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Archosauria',
        label: 'Archosauria - Wikipedia',
      },
      {
        url: 'https://www.earth.com/news/crocodiles-birds-archosaurs/',
        label: 'Earth.com - Crocodiles and birds are archosaurs',
  ...
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Euphorbia',
        label: 'Euphorbia - Wikipedia',
      },
      {
        url: 'https://plantconvergentevolution.weebly.com/convergent-evolution.html',
        label: 'Convergent evolution of cacti and euphorbias',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Brassicales',
        label: 'Brassicales - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Pitcher_plant',
        label: 'Pitcher plant - Wikipedia',
      },
      {
        url: 'https://www.science.org/doi/10.1126/science.ade0529',
        label: 'Science - Convergence in carnivorous pitcher plants',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Dendrosenecio',
        label: 'Dendrosenecio - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Malpighiales',
        label: 'Malpighiales - Wikipedia',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Dracaena_(plant)',
        label: 'Dracaena - Wikipedia',
      },
    ],
  },
    ...
    sources: [
      {
        ...
        label:
          "World's Simplest Animal Reveals Hidden Diversity - Quanta Magazine",
      },
      {
        url: 'https://www.nature.com/articles/nature07191',
        label: 'Nature - The Trichoplax genome and the nature of placozoans',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://onlinelibrary.wiley.com/doi/full/10.1002/bies.202100080',
        label: 'BioEssays - The enigmatic Placozoa: evolutionary controversies',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Xenacoelomorpha - Wikipedia',
      },
      {
        url: 'https://www.nature.com/articles/nature16520',
        label: 'Nature - Xenacoelomorpha is the sister group to Nephrozoa',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Hydra_(genus)',
        label: 'Hydra - Wikipedia',
      },
      {
        url: 'https://biology.ucdavis.edu/news/hydra-and-quest-understand-immortality',
        label: 'UC Davis - Hydra and the quest to understand immortality',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.cell.com/trends/neurosciences/fulltext/S0166-2236(22)00180-1',
        label:
          'Trends in Neurosciences - Ctenophores and the evolutionary origin(s) of neurons',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Xenacoelomorpha#Phylogenetic_position',
        label: 'Xenacoelomorpha phylogenetic position - Wikipedia',
      },
      {
        url: 'https://link.springer.com/article/10.1007/s13127-015-0239-1',
        label:
          'Organisms Diversity & Evolution - Acoelomorpha: earliest branching bilaterians or deuterostomes?',
      },
    ],
  },
  {
    ...
    sources: [
      {
        url: 'https://en.wikipedia.org/wiki/Platyhelminthes',
        label: 'Platyhelminthes - Wikipedia',
      },
      {
        url: 'https://elifesciences.org/articles/05503',
        label:
          'eLife - Nuclear genomic signals of platyhelminth evolutionary innovation',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        label: 'Myxozoa - Wikipedia',
      },
      {
        url: 'https://www.smithsonianmag.com/smart-news/parasite-really-micro-jellyfish-180957326/',
        label: 'Smithsonian - This parasite is really a micro-jellyfish',
      },
    ],
  },
    ...
    sources: [
      {
        ...
        label: 'Termite - Wikipedia',
      },
      {
        url: 'https://www.smithsonianmag.com/smart-news/termites-are-moving-cockroaches-taxonomically-180968332/',
        label: 'Smithsonian - Termites are moving in with cockroaches',
      },
      {
        url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC2464702/',
        label: 'PMC - Termites are eusocial cockroaches',
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.mapress.com/pe/article/view/palaeoentomology.3.6.16',
        label: 'Palaeoentomology - Fleas are parasitic scorpionflies',
      },
    ],
  },
]
